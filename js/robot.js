...
function createRobot() {
  // Color meshes
  const white_mesh = new THREE.MeshStandardMaterial({
    color: 0xffffff,
    metalness: 1,
    roughness: 0.4,
  });
  ...
  const orange_base = new THREE.Mesh(orange_base_geometry, white_mesh);
  ...
  const base_box = new THREE.Mesh(base_box_geometry, white_mesh);
  ...
  const first_arm = new THREE.Mesh(first_arm_geometry, white_mesh);
  ...
  const second_base = new THREE.Mesh(second_base_geometry, white_mesh);
  ...
  const arm_sides = new THREE.Mesh(side_arm_geometry, white_mesh);
  ...
  const hand_junction = new THREE.Mesh(hand_junction_geometry, white_mesh);
  ...
  const lateral_junc_1 = new THREE.Mesh(lateral_geometry, white_mesh);
  ...
  const lateral_junc_2 = new THREE.Mesh(lateral_geometry, white_mesh);
  ...
  const wrist_top = new THREE.Mesh(wrist_top_geometry, white_mesh);
  ...
  const invisibleBox = new THREE.Mesh(invisibleBoxGeometry, white_mesh);
